...
Instead of talking to El Sharaawy:
	If the player says "safe" or "protect":
		now El Sharaawy is happy;
		say "I guess that did the trick. 'I'll trust you' he says and picks himself off the pile of bags.";
	Otherwise:
		say "El Sharaawy still looks scared as ever. He refuses to follow you out of the bus but you have to convince him to follow you. You decide to try again."
